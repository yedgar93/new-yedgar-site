...
export default function PressPage() {
  return (
    <main className="view-full animate-fade-in light-page">
      <LazyMount placeholder={<div className="canvas-placeholder fluid-placeholder" />}>
        <FluidBackground />
      </LazyMount>
      ...
      <div className="max-w-2xl px-6 text-center">
        ...
        {/* Press Links */}
        <ul className="text-md font-light leading-relaxed tracking-tight text-fg animate-fade-up delay-2 space-y-5 flex flex-col items-center">
